...
import { ModernTemplatePDF } from '@/components/resume-builder/templates/test-template'; 
...
import { Download, FilePlus2, Eye, Loader2 } from 'lucide-react';
...
export default function ResumeBuilderPage() {
  ...
  const updateResumeData = (section, dataOrValue) => {
    ...
    const ResumePDF = ModernTemplatePDF; // For now, we only have one
          ...
          <Card className="shadow-lg rounded-xl overflow-hidden">
           ...
           <Button onClick={handleDownload} className="w-full mt-6 h-12 text-base" size="lg">
            ...
            <PDFDownloadLink
                    ...
                    fileName={/* ... your filename logic ... */ `resume.pdf`}
                >
                    {({ loading }) => (
